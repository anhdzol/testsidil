...
breve tour por el catalogo de indicadores, mostrando como de lo más básico (promedio nacional) llegas a lo más granular: 3_geo5_act3_tam ]{.mark}
...
```{r MPRcomplementaria, echo=FALSE, fig.cap ="Matriz de predicción de riesgos (ilustración complementaria)"}
#Nota, los nombre de referencia no pueden tener guion bajo
