...
```{r pipelsimplaaificado2, echo=FALSE, out.width="50%", fig.cap ="Pipeline simplificado del SIDIL  (versión simplificada)"}
...
```{r modulosSIDIL, echo=FALSE ,out.width="50%", fig.cap ="Módulos que componen el SIDIL"}
#Nota, los nombre de referencia no pueden tener guion bajo
...
```{r modularizacionSIDIL, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Modularización del SIDIL", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
...
```{r utilidadestimacionespuntuales, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="El aprovechamiento de los niveles de agregación en el cálculo de indicadores.", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
...
```{r aprovechamientonivelesagregacion, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="El aprovechamiento de los niveles de agregación en el cálculo de indicadores (segunda parte)", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
# htmltools::HTML(fn('Nombre del recuadro desde DIV...'))
```
...
```{r sentidoindicadores, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="El sentido de los indicadores", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
# htmltools::HTML(fn('Nombre del recuadro desde DIV...'))
```
...
```{r relacionDNESNILESIAPISIPAS, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Relación DNE-SNILE-SIAPI-SIPAS con el matching nominativo del IMSS", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
# htmltools::HTML(fn('Nombre del recuadro desde DIV...'))
```
...
knitr::include_graphics("images-1/02/MPR_simplificada.png")
...
```{r utilizacioninterfazauto, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="La utilización de la interfaz de automatización", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
# htmltools::HTML(fn('Nombre del recuadro desde DIV...'))
```
