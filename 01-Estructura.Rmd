...
El resultado del mósulo I son diversas tablas en formato .Rds que contienen las estimaciones puntuales de todos los indicadores de todas las fuentes de información, así como la información sobre los niveles de agregación e información complementaria del cálculo. 
...
[AQU POSIBLEMENTE CONVIENE INCORPORAR UNA ILUSTRACION SOBRE RELACION SIAPI SIPAS, DNE Y SIDIL]{.mark}
...
```{r arboldecision, echo=FALSE, fig.cap ="Ejemplo de un árbol de decisión"}
#Nota, los nombre de referencia no pueden tener guion bajo
