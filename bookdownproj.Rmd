...
```{r pipelsimplaaificado2, echo=FALSE, fig.cap ="Pipelinse ilustrativo del SIDIL  (versión simplificada)"}
#Nota, los nombre de referencia no pueden tener guion bajo

knitr::include_graphics("images-1/02/image2_alternativaTD.jpg")
...
```{r scriptinputoutput,echo=FALSE, fig.cap = 'Relación input-script-output'}
knitr::include_graphics("images-1/02/script_input_output.png")
```
...
```{r modulosSIDIL, echo=FALSE, fig.cap ="Módulos que componen el SIDIL"}
#Nota, los nombre de referencia no pueden tener guion bajo
...
Ilustración 3 Tipos de columnas que componen la Matriz de Predicción de Riesgos (MPR)
...
![](./media/image6.png){width="2.5076388888888888in" height="2.5965277777777778in"}
...
|                                                                                                                                                                                                                                                                                                                                                                          |
| -   Primero, resguardar una copia del catálogo desactualizado en la subcarpeta *anteriores_descartar* que se encuentra en su respectiva carpeta. Se sugiere guardarlo con la fecha en la que dicho catalogo fue reemplazado.                                                                                                                                             |
|                                                                                                                                                                                                                                                                                                                                                                          |
| -   Segundo, modificar y/o reemplazar el catálogo, para que esta sea procesada correctamente por los scripts, sin cambiar el nombre del archivo del catálogo.                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                          |
...
## La Matriz de Predicción de Riesgo {#MPRgeneral}
...
:speech_balloon: **This is a note**: ara calcular un nuevo indicador es necesario seguir el siguiente procedimiento


> **_Recuadro 9 Procedimiento para la inclusión de nuevos indicadores:_**  ara calcular un nuevo indicador es necesario seguir el siguiente procedimiento
...
+==========================================+====================================================================+========================================================================================================================+=================================================================================================================================================================================================+=======================================================================================================================================================================+
| Script secue nciador: 1_C\_1_S \_SE_ENOE | Script de configuración inicial:                                   | Decla ración de pará metros en la RAM                                                                                  | "Hora sistema. INFO: Se ha ejecutado con exito el scipt 0_config\_ inicial.R"                                                                                                                   | Ver sección 3 .9**Error! Reference source not found.**                                                                                                                |
|                                          |                                                                    |                                                                                                                        |                                                                                                                                                                                                 |                                                                                                                                                                       |
...
\| \| patrones \| ecimiento. \| al \\[fecha \| \|]. Ultimo \| \|
...
\*\*Hay dos principales problemas que podrían ocurrir\*\*[. Primero, que no]{.mark} Segundo, que no se pueda
...
[\<XXXX\@stps.gob.mx\> . El acceso a esta interfaz es a través de la]{.mark}
...
Cuando terminan de correr los procesos seleccionados ([siempre y cuando]{.mark} se habilitan los botones de la sección de \*Descarga de
...
la sección y se podrá realizar otra selección. [Cabe destacar que en]{.mark}
...
\| [El análisis Shapley se utiliza para comprender la contribución de \|]{.underline} \|
