...
```{r IndicadoresNuevos1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Procedimiento para la inclusión de nuevos indicadores", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
...
```{r nuevosypreexistentes1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Distinción entre incorporación de nuevos indicadores y actualización de método de cálculo de indicadores preexistentes", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r modificacionagregacion1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Modificaciones a los niveles de agregación", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r estimacionespuntuales1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Organización de las estimaciones puntuales por indicador", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r resguardobases1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap=" Resguardo de las bases originales", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r formatoperiodos1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap=" Formato de periodo de referencia de los insumos del IMSS", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r parametrosimss1, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Configuración de parámetros del script secuenciador del IMSS", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r parametrosimsshist, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Configuración de parámetros del script secuenciador del IMSS para el cálculo histórico", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r modelos, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Modelos Random Forest y Tabnet", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r nuevassubmaterias, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Inclusión de submaterias para la predicción", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r shap, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Reporte Shapley", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
