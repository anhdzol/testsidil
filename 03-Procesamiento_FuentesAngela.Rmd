...
```{r setup031, include=FALSE, echo=FALSE}
fn = local({
  i = 0
  function(x) {
    i <<- i + 1
...
```{r IndicadoresNuevos, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Procedimiento para la inclusión de nuevos indicadores", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
...
```{r nuevosypreexistentes, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Distinción entre incorporación de nuevos indicadores y actualización de método de cálculo de indicadores preexistentes", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r modificacionagregacion, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Modificaciones a los niveles de agregación", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r estimacionespuntuales, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Organización de las estimaciones puntuales por indicador", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
kable(tabla1, caption = "Resumen de las fuentes de información utilizadas en el SIDIL") %>%
  ...
  footnote(general = "Los detalles de las fuentes de información se presentan en el Módulo II")
```
...
```{r resguardobases, class.source='myClass', echo=FALSE, out.width="50px", fig.cap=" Resguardo de las bases originales", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r formatoperiodos, class.source='myClass', echo=FALSE, out.width="50px", fig.cap=" Formato de periodo de referencia de los insumos del IMSS", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
```{r parametrosimss, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Configuración de parámetros del script secuenciador del IMSS", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
knitr::include_graphics("images-1/important-icon.svg")
```
...
# grouping_vars <- c("Ejecución del usuario", "Ejecución automatizada", "Output")
# tablax <- collapse_rows_df(tabla1, grouping_vars)
