...
```{r indiceinspecciones, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Conformación del *índice* de inspecciones", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
