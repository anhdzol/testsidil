...
```{r testBox, class.source='myClass', echo=FALSE, out.width="50px", fig.cap="Titulo dado en fig.cap donde va icono", out.extra='style="float:left; background-color: #f5f5f5; padding-right:1em"'}
